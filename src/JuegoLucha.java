...
public class JuegoLucha {
    ...
    public void iniciarPelea() {
        ...
        while (jugador1.getPersonaje().estaVivo() && jugador2.getPersonaje().estaVivo()) {
            ...
            setEstado(jugador1.getPersonaje());
            setEstado(jugador2.getPersonaje());
        }
    ...
    private void setEstado(Personaje personaje) {
        if (!personaje.estaVivo()) {
            personaje.setEstado(EstadoPersonaje.MUERTO);
        } else {
            personaje.setEstado(EstadoPersonaje.VIVO);
        }
    }
